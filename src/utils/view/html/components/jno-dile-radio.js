...
export class JnoDileRadio extends LitElement {
    static styles = [
        css`
            :host {
                display: block;
    ...
    select() {
        this.dispatchEvent(new CustomEvent('jno-dile-radio-selected', {
            bubbles: true,
            composed: true,
            detail: {
                value: this.value,
...
customElements.define('jno-dile-radio', JnoDileRadio);