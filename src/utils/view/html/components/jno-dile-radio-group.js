...
export class JnoDileRadioGroup extends DileEmmitChangeMixin(LitElement) {
  static styles = [
    css`
      :host {
        display: block;
  ...
  render() {
    return html`
      <div @jno-dile-radio-selected=${this.changeValue}>
        ${this.label
  ...
  doSelection(newValue) {
    let numSelected = 0;
    this.querySelectorAll('jno-dile-radio').forEach(radio => {
...
customElements.define("jno-dile-radio-group", JnoDileRadioGroup);